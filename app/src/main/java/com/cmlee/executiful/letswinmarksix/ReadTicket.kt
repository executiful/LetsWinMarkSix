...
import com.cmlee.executiful.letswinmarksix.databinding.ActivityReadTicketBinding
...
class ReadTicket : AppCompatActivity() {
    ...
    private val TAG = "ReadTicket"
    private lateinit var binding: ActivityReadTicketBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityReadTicketBinding.inflate(layoutInflater)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.menu_read_ticket, menu)
        return true
    }
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdLoaded(ad: InterstitialAd) {
                    ...
                    Toast.makeText(this@ReadTicket, "onAdLoaded()", Toast.LENGTH_SHORT)
                        .show()
